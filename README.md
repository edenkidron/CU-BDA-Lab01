...
- Steps in descrete sequence (0-40) (columns)
- Each respondent ranked 20 options on the descrete scale 
- The number of steps each respondent could have ranked is between 0 - 40 
- Each option must be ranked at least once and up to twice on the scale
...
a start and end fence lines to delimit the code block. options
```
